    ...
    public partial class AddProductToDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 6, 30, 10, 39, 36, 306, DateTimeKind.Local).AddTicks(2044), 1, "Action" },
                    { 2, new DateTime(2023, 6, 30, 10, 39, 36, 306, DateTimeKind.Local).AddTicks(2064), 2, "Horror" },
                    { 3, new DateTime(2023, 6, 30, 10, 39, 36, 306, DateTimeKind.Local).AddTicks(2065), 3, "SciFi" }
                });
